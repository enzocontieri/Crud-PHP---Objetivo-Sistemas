    ...
    <main>
        ...
        <form method="POST" action="index.php"> 
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="Alguma Observação Aqui !" name="observacao" rows="3"></textarea>
            </div>
                            ...
                            <div class="col">
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        ...
                                        <label class="text-uppercase"><strong>Observação:</strong></label>
                                        <p class="card-text"><?= $cliente['observacao'] ?></p>
